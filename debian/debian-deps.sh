#!/bin/bash
DEPS="libopencv-dev libcv-dev libcvaux-dev libhighgui-dev libglade2-dev libgl1-mesa-dev libglu1-mesa-dev libftgl-dev libsdl1.2-dev libsdl-mixer1.2-dev lsb-release pkg-config"
REAL_DEPS=""
for dep in $DEPS; do
